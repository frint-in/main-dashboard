...
export default function SignIn({setIsAdminAuthenticated}) {
  ...
  const handleUser = async (e) => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_REACT_API_URL}api/auth/signin`, { email, password },
    ...
    <div className="mt-16 mb-16 flex h-full w-full items-center justify-center px-2 md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-center" >
      ...
      <div className="mt-[10vh] w-full max-w-full flex-col items-center md:pl-4 lg:pl-0 xl:max-w-[420px]">
        ...
        <p className="mb-9 ml-1 text-base text-gray-600 text-center">
          Don't have an account? <Link to="/sign-up" className="text-brand-500"> Register </Link> 
        </p>
