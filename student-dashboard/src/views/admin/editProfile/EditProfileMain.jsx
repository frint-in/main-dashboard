    ...
    .object({
      classX: z
        .object({
          ...
          boards: z.string().min(1, "Boards are required").optional(),
          percentage: z
            .string()
  ...
  useEffect(() => {
    if (userDetails) {
      ...
      switch (stepIndex) {
        ...
        case 1:
          setValue(
            "education.classX.school",
            userDetails.education?.classX?.school || ""
          );
          setValue(
            "education.classX.boards",
            userDetails.education?.classX?.boards || ""
          );
          setValue(
            "education.classX.percentage",
            userDetails.education?.classX?.percentage || ""
          );
          setValue(
            "education.classXII.school",
            userDetails.education?.classXII?.school || ""
          );
          setValue(
            "education.classXII.boards",
            userDetails.education?.classXII?.boards || ""
          );
          setValue(
            "education.classXII.percentage",
            userDetails.education?.classXII?.percentage || ""
          );
          setValue(
            "education.graduation.college",
            userDetails.education?.graduation?.college || ""
          );
          setValue(
            "education.graduation.university",
            userDetails.education?.graduation?.university || ""
          );
          setValue(
            "education.graduation.percentage",
            userDetails.education?.graduation?.percentage || ""
          );
          break;
        case 2:
