...
const SignIn = ({ user, setUser }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
      <main className="flex flex-col justify-center items-center w-full flex-1 px-4 md:px-20 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row w-full md:w-2/3 max-w-4xl">
            ...
            <div className="py-10">
              ...
              <div className="flex flex-col items-center">
                ...
                <button
                  ...
                  className="border-2 border-blue-500 text-blue-500 rounded-full px-12 py-2 mt-10 inline-block font-bold hover:text-white hover:bg-blue-500"
                >
                  Sign in
                </button>
              </div>
          ...
          <div className="w-full md:w-2/5 bg-blue-500 text-white rounded-b-2xl md:rounded-tr-2xl md:rounded-br-2xl py-36 px-12">
            ...
            <Link to="/signup">
              <p className="border-2 border-white text-white rounded-full px-12 py-2 inline-block font-bold hover:text-blue-500 hover:bg-white">
                Sign Up
              </p>
            </Link>
          </div>
