...
export async function getAllApprovedApplicants() {
  try {
    ...
    const response = await axios.get(`${import.meta.env.VITE_REACT_API_URL}api/internship/getUsersWithapproved`);
    // console.log("hi1");
...
export async function getAllPendingApplicants() {
  try {
    const response = await axios.get(`${import.meta.env.VITE_REACT_API_URL}api/internship/getUsersWithpending`);
    // console.log("hi1");
...
export async function getIntershipById(id) {
  try {
    // console.log("hi1");
    // const response = await axios.get(`${AXIOS_BASE_URL}/api/internship/all`);
    const response = await axios.get(`${import.meta.env.VITE_REACT_API_URL}api/internship/find/${id}`);
    // console.log("hi1");
...
export async function getUsersWithIntershipId(id) {
  try {
    // console.log("hi1");
    // const response = await axios.get(`${AXIOS_BASE_URL}/api/internship/all`);
    const response = await axios.get(`${import.meta.env.VITE_REACT_API_URL}api/internship/getUsersWithInternship/${id}`);
    // console.log("hi1");
...
export async function approveUserByIntershipId(internshipId, userId) {
  try {
    // console.log("hi1");
    // const response = await axios.get(`${AXIOS_BASE_URL}/api/internship/all`);
    const response = await axios.post(`${import.meta.env.VITE_REACT_API_URL}api/internship/updatetoapprove/${internshipId}`, {
      id: userId
  });
  const data = response.data;
  // console.log("data>>>>", data);
...
export async function completeUserByIntershipId(internshipId, userId) {
  try {
    // console.log("hi1");
    // const response = await axios.get(`${AXIOS_BASE_URL}/api/internship/all`);
    const response = await axios.post(`${import.meta.env.VITE_REACT_API_URL}api/internship/updatetocomplete/${internshipId}`, {
      id: userId
    });
    // console.log("hi1");
