  ...
  return (
    <input
      ...
      className={`before:contet[""] relative h-5 w-5 cursor-pointer appearance-none rounded-full
       ...
       before:left-[50%] before:h-3 before:w-3 before:translate-x-[-50%] before:rounded-full before:transition-all dark:!border-gray-800
       ${
         color === "red"
           ...
           : color === "green"
           ? "checked:!border-green-500 checked:before:!bg-green-500 dark:checked:!border-green-400 dark:checked:before:!bg-gresen-400"
           : color === "yellow"
